...
describe('CPF', () => {
    describe('create', () => {
        ...
        describe('should fail to create an invalid', () => {
            const failureCases = [
                { cpf: null, scenario: 'when CPF is null', errorCodeExpected: 'FIELD_CANNOT_BE_NULL' },
                { cpf: undefined, scenario: 'when CPF is undefined', errorCodeExpected: 'FIELD_CANNOT_BE_NULL' },
                { cpf: '', scenario: 'when CPF is empty', errorCodeExpected: 'FIELD_CANNOT_BE_EMPTY' },
                { cpf: '123456789012', scenario: 'when CPF has less than 13 digits', errorCodeExpected: 'INVALID_CPF_FORMAT' },
                { cpf: '12345678901234', scenario: 'when CPF has more than 13 digits', errorCodeExpected: 'INVALID_CPF_FORMAT' },
                { cpf: '1234567890abc', scenario: 'when CPF contains non-numeric characters', errorCodeExpected: 'INVALID_CPF_FORMAT' }
            ];
