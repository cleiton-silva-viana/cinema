...
describe('ArrayValidator', () => {
  describe('isNotEmpty', () => {
    ...
    it('deve incluir detalhes adicionais na falha', () => {
      ...
      // Act
      new ArrayValidator({ itens: value }, failures).isNotEmpty(FailureCode.MISSING_REQUIRED_DATA, details)
  ...
  describe('hasLengthBetween', () => {
    ...
    it('deve usar o código de erro personalizado', () => {
      ...
      // Act
      new ArrayValidator({ itens: value }, failures).hasLengthBetween(min, max, code)
  ...
  describe('contains', () => {
    ...
    it('deve incluir detalhes adicionais na falha', () => {
      ...
      // Act
      new ArrayValidator({ itens: value }, failures).contains(item, FailureCode.MISSING_REQUIRED_DATA, details)
  ...
  describe('every', () => {
    ...
    it('deve incluir detalhes adicionais na falha', () => {
      ...
      // Act
      new ArrayValidator({ itens: value }, failures).every(predicate, FailureCode.CONTENT_WITH_INVALID_ITEMS, details)
  ...
  describe('some', () => {
    ...
    it('deve incluir detalhes adicionais na falha', () => {
      ...
      // Act
      new ArrayValidator({ itens: value }, failures).some(predicate, FailureCode.MISSING_VALID_ITEM, details)
