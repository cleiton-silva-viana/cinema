...
describe('DateValidator', () => {
  ...
  describe('isAfter', () => {
    ...
    it('deve incluir detalhes adicionais na falha', () => {
      ...
      // Act
      new DateValidator({ data: startDate }, failures).isAfter(endDate, FailureCode.DATE_NOT_AFTER_LIMIT, commonDetails)
  ...
  describe('isBetween', () => {
    describe('cenários onde não deve ocorrer falha', () => {
      const successCases = [
        {
          scenario: 'não deve adicionar falha quando a data estiver dentro do intervalo',
          date: dataMiddle,
        },
        {
          scenario: 'não deve adicionar falha quando a data for igual à data de início',
          date: new Date(startDate),
        },
        {
          scenario: 'não deve adicionar falha quando a data for igual à data de fim',
      ...
      successCases.forEach(({ scenario, date }) => {
        it(scenario, () => {
          ...
          // Act
          new DateValidator({ data: date }, failures).isBetween(startDate, endDate)
    ...
    describe('cenários onde deve ocorrer uma falha', () => {
      const failureCases = [
        {
          scenario: 'deve adicionar falha quando a data for anterior à data de início',
          date: dataBefore,
        },
        {
          scenario: 'deve adicionar falha quando a data for posterior à data de fim',
          date: dataAfter,
        },
      ]
    ...
    it('deve usar o código de erro personalizado', () => {
      ...
      // Act
      new DateValidator({ data: dataAfter }, failures).isBetween(startDate, endDate, code)
    ...
    it('deve lidar com startDate inválido', () => {
      ...
      for (const date of invalidDates) {
        ...
        // Act & Assert
        expect(() => {
          new DateValidator({ data: dataMiddle }, failures).isBetween(date, endDate)
        }).toThrow()
      }
    })
    ...
    it('deve lidar com endDate inválido', () => {
      ...
      for (const date of invalidDates) {
        ...
        // Act & Assert
        expect(() => {
          new DateValidator({ data: dataMiddle }, failures).isBetween(startDate, date)
        }).toThrow()
      }
    })
