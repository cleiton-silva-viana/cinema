...
describe("Price", () => {
  function createValidPrice(value: number) {
  ...
  describe("operations", () => {
    ...
    describe("subtract", () => {
      ...
      it("deve falhar quando a subtração resulta em valor negativo", () => {
        ...
        expect(failures[0].code).toBe(
          FailureCode.PRICE_NEGATIVE_RESULT_NOT_ALLOWED,
        );
      });
    ...
    describe("multiply", () => {
      ...
      it("deve falhar quando o fator de multiplicação não é um número", () => {
        ...
        expect(failures.length).toBe(1);
        expect(failures[0].code).toBe(
          FailureCode.PRICE_INVALID_MULTIPLICATION_FACTOR,
        );
      });
      ...
      it("deve falhar quando o fator de multiplicação é negativo", () => {
        ...
        expect(failures.length).toBe(1);
        expect(failures[0].code).toBe(
          FailureCode.PRICE_NEGATIVE_FACTOR_NOT_ALLOWED,
        );
      });
    });
    ...
    describe("divide", () => {
      ...
      it("deve falhar quando o divisor não é um número", () => {
        ...
        expect(failures.length).toBe(1);
        expect(failures[0].code).toBe(
          FailureCode.PRICE_INVALID_DIVISION_FACTOR,
        );
      });
      ...
      it("deve falhar quando o divisor é zero", () => {
        ...
        expect(failures.length).toBe(1);
        expect(failures[0].code).toBe(
          FailureCode.PRICE_ZERO_OR_NEGATIVE_DIVISOR_NOT_ALLOWED,
        );
      });
